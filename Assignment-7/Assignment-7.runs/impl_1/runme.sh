...
HD_PWD='/home/tanish/Desktop/GitHub/COL215/Assignment-7/Assignment-7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design2.tcl -notrace
