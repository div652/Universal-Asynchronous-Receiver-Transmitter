...
HD_PWD='/home/divyanshu/Assignments/Assignment1/Assignment1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DesignFile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DesignFile.tcl
