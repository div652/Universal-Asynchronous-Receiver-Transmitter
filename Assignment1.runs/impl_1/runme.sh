...
HD_PWD='/home/divyanshu/Assignments/Assignment1/Assignment1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DesignFile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DesignFile.tcl -notrace
