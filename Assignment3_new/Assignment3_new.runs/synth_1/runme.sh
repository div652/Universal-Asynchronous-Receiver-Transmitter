...
HD_PWD='/home/divyanshu/Assignments/Assignment1/Assignment3_new/Assignment3_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lightDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lightDisplay.tcl
